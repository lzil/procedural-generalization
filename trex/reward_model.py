...
def main():
    ...
    policy_model = ppo2.learn(env=venv, network=conv_fn, total_timesteps=0)
    demonstrations, learning_returns, learning_rewards = generate_procgen_demonstrations(lambda: venv, args.models_dir, policy_model, args.num_envs)
