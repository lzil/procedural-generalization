...
print(pearson_base, spearman_base)
# ax = means.plot(y=['spearman', 'pearson'], yerr=stds, kind='bar', capsize=4, figsize=(16, 9))
# ax = filtered_RMs.plot(x = 'num_dems', y='spearman', yerr=stds, kind='scatter',figsize=(16, 9))
filtered_RMs[['spearman','num_dems']].boxplot(by='num_dems')
